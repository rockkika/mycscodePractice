...
struct FrameStatus {
  ...
  std::list<frame_id_t>::iterator frame_iter_;
  std::list<page_id_t>::iterator page_iter_;
  FrameStatus(page_id_t page_id, frame_id_t frame_id, bool evictable, ArcStatus arc_status,
   const std::list<frame_id_t>::iterator &frame_iter, const std::list<page_id_t>::iterator &page_iter)
   : page_id_(page_id),
     frame_id_(frame_id),
     evictable_(evictable),
     arc_status_(arc_status),
     frame_iter_(frame_iter),
     page_iter_(page_iter) {
  }
};
